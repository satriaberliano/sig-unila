  ...
  return (
    <div className="basis-1/6 bg-[#F1F1F1] py-4 h-screen space-y-10">
      <div className="py-8 space-y-4">
        <Image src={assets.logoUnila} alt="Universitas Lampung logo" className="w-2/6 mx-auto"></Image>
      ...
      <div className="space-y-1">
        <Link
          href="/dashboard"
          className={`p-4 flex justify-center items-center gap-4  hover:font-medium ${pathname === "/dashboard" ? "bg-[#0F6EE3] text-white hover:text-black" : "hover:bg-[#0F6EE3] hover:text-white"}`}
        >
        ...
        <Link
          href="/data-fasilitas"
          className={`p-4 flex justify-center items-center gap-4 hover:font-medium  ${pathname === "/data-fasilitas" ? "bg-[#0F6EE3] text-white hover:text-black" : "hover:bg-[#0F6EE3] hover:text-white"}`}
        >
