    ...
    try {
      ...
      if(imageUpload){
        ...
        if(dataImage){
          ...
          const { error }= await supabase.from("fasilitas")
          .update([
            {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-6">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-y-4">
              ...
              <div>
                <label htmlFor="imageUpload" className="cursor-pointer text-xs px-3 py-2 rounded-md text-white bg-[#0F6EE3]">Pilih Berkas</label>
                <input
                  name="url_image"
                  type="file"
                  id="imageUpload"
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input name="name" type="text" className="border-2 rounded-md pl-2 py-1 text-sm" {...register('name')}/>
          </div>
          <div className="flex flex-col space-y-2">
            <h3 className="font-medium">Deskripsi Fasilitas</h3>
            <textarea name="description" id=""  rows="8" className="border-2 rounded-md pl-2 py-1 text-xs " {...register('description')}></textarea>
          </div>
          <div className="flex flex-col space-y-3">
            <h3 className="font-medium pb-1">Titik Koordinat</h3>
            <div className="w-full space-y-1">
              <h4 className="text-sm">Garis Lintang (Latitude)</h4>
              <input name="latitude" type="text" className="border-2 rounded-md pl-2 py-1 text-sm w-full" {...register('latitude')}/>
            </div>
            <div className="w-full space-y-1">
              <h4 className="text-sm">Garis Bujur (Longitude)</h4>
              <input name="longitude" type="text" className="border-2 rounded-md pl-2 py-1 text-sm w-full" {...register('longitude')}/>
            </div>
          </div>
          <button 
            type="submit" 
